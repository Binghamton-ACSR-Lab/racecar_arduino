...
*****************************************************/
AMS_5600::AMS_5600(byte address)
{
  /* set i2c address */
...
*******************************************************/
byte AMS_5600::getMagnetStrength()
{
  byte magStatus;
  byte retVal = 0;
  /*0 0 MD ML MH 0 0 0*/
...
*******************************************************/
byte AMS_5600::readOneByte(byte in_adr)
{
  byte retVal = -1;
  //Serial.println("HERE1");
  //Serial.println(_ams5600_Address,HEX);
...
*******************************************************/
word AMS_5600::readTwoBytes(byte in_adr_hi, byte in_adr_lo)
{
  word retVal = -1;
  byte low=0;
  byte high=0;
